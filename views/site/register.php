        ...
        <form id="login-form" action="/register" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="item">
                        <label>
                            <span><?=Yii::t('app','Your name')?> <i>*</i></span>
                ...
                <div class="col-md-4">
                    <div class="item">
                        <label>
                            <span><?=Yii::t('app','Username (nickname)')?> <i>*</i></span>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="item">
                        <label>
                            <span><?=Yii::t('app','Country')?> <i>*</i></span>
                    ...
                    <div class="checkbox">
                        ...
                        <label for="check"  >
                            <span style="font-size: 18px;position: relative;bottom: 5px;">
                                <?=Yii::t('app','I agree to the')?> 
                                <a href="GDPR Terms"><?=Yii::t('app','GDPR Terms')?></a>
                            </span>
                        </label>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary submit-btn"><?=Yii::t('app','Sign in')?>&nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                </div>
            </div>
