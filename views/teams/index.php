...
<section class="image-header">
    <div class="player-photo geme-foto">
        <img class="img-responsive" src="/images/profile/images122.jpg" alt="player">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="staff-box">            
                ...
                <div class="col-md-4  col-sm-6 col-xs-12 image_big">
                    <a href="player.html" class="item">
                        ...
                        <img src="http://playerx.edge-themes.com/wp-content/uploads/2018/06/p2-team-img-2.jpg" alt="player">
                    </a>
                </div>
                <div class="col-md-4  col-sm-6 col-xs-12 image_big">
                    <a href="player-second-page.html" class="item">
                                ...
                                <img src="http://playerx.edge-themes.com/wp-content/uploads/2018/06/p2-team-img-3.jpg" alt="player">
                    </a>
                </div>   
                <div class="col-md-4  col-sm-6 col-xs-12 image_big">
                    <a href="player.html" class="item">
                                ...
                                <img src="http://playerx.edge-themes.com/wp-content/uploads/2018/06/p2-team-img-5.jpg" alt="player">
                    </a>
                </div>     
                <div class="col-md-4  col-sm-6 col-xs-12 image_big">
                    <a href="player-second-page.html" class="item">
...
<section class="contacts-wrap">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="col-md-12" style="margin-top: 10px;" >
                    <h3 style="margin-bottom: 0;padding-bottom: 0;" >WANNA BE A<br> PART OF THE PACK?</h3>
                ...
                <div class="leave-comment-wrap">
                    <form>                              
                        <div class="row">
                            <div class="col-md-12">
                                <div class="item">
                                    <input type="text" name="name" placeholder="Your Nane" >
                                </div>  
                            </div>
                            <div class="col-md-12">
                                <div class="item">
                                    <input type="text" name="subjects" placeholder="Email Adress">
                                </div>  
                            </div>
                            <div class="col-md-12">
                                <div class="item">
                            ...
                            <div class="col-md-12">
                                <button class="comment-submit" style="width: 100%;">Send us message</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="contacts-map">
        <img class="img-responsive" src="images/hockey/contacts-map.jpg" alt="contacts-map">
    </div>
</section>
