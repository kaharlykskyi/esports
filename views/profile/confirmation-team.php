...
<div class="container" style="margin-top: 50px;">
	<div class="row">
		<div class="col-md-6 col-md-offset-3 text-center" style="margin-bottom: 40px;">
            <h2><?=Yii::t('app','New invite to the team')?></h2>
			...
			<div class="col-md-6">
				<a href="/profile/confirmation-team?confirmation_tokin=<?=$confirmation_tokin?>&status=2" class="btn"><?=Yii::t('app','ACCEPT')?></a>
			</div>
			<div class="col-md-6">
				<a href="/profile/confirmation-team?confirmation_tokin=<?=$confirmation_tokin?>&status=3" class="btn btn-red"><?=Yii::t('app','DECLINE')?></a>
			</div>
		</div>
	</div>
</div>